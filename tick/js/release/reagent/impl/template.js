...
var G__13602 = o;
(G__13602[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__13608 = jsprops;
(G__13608["defaultValue"] = value);

(G__13608["onChange"] = ((function (G__13608,v,value,on_change){
return (function (p1__13607_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13607_SHARP_);
});})(G__13608,v,value,on_change))
);
...
var vec__13611 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13611,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13611,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13611,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13615 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13615 == null)){
} else {
var key_13616 = temp__4661__auto___13615;
(jsprops["key"] = key_13616);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13617 = reagent.impl.template.__GT_NativeWrapper();
(G__13617["name"] = c);
...
var G__13618 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13618) : reagent.impl.template.as_element.call(null,G__13618));
} else {
...
var len__8839__auto___13623 = arguments.length;
var i__8840__auto___13624 = (0);
while(true){
if((i__8840__auto___13624 < len__8839__auto___13623)){
args__8846__auto__.push((arguments[i__8840__auto___13624]));

var G__13625 = (i__8840__auto___13624 + (1));
i__8840__auto___13624 = G__13625;
continue;
} else {
}
break;
...
break;
default:
var G__13628 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13628;
continue;
...
var n__8615__auto___13630 = a.length;
var i_13631 = (0);
while(true){
if((i_13631 < n__8615__auto___13630)){
(a[i_13631] = reagent.impl.template.as_element((a[i_13631])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8615__auto___13633 = a.length;
var i_13634 = (0);
while(true){
if((i_13634 < n__8615__auto___13633)){
var val_13635 = (a[i_13634]);
if((cljs.core.vector_QMARK_(val_13635)) && ((reagent.impl.template.key_from_vec(val_13635) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13634] = reagent.impl.template.as_element(val_13635));

var G__13636 = (i_13634 + (1));
i_13634 = G__13636;
continue;
} else {
}
...
var ctx = ({});
var vec__13637 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13637,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13637,(1),null);
...
var G__13640 = (cljs.core.count(argv) - first_child);
switch (G__13640) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13640){
